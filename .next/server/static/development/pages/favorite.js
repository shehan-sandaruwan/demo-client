...
/* harmony import */ var _component_FavoriteItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../component/FavoriteItem */ "./component/FavoriteItem.js");
/* harmony import */ var isomorphic_fetch__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! isomorphic-fetch */ "isomorphic-fetch");
/* harmony import */ var isomorphic_fetch__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(isomorphic_fetch__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _public_utils_module_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../public/utils.module.css */ "./public/utils.module.css");
/* harmony import */ var _public_utils_module_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_public_utils_module_css__WEBPACK_IMPORTED_MODULE_5__);
...
class Favorite extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  async fetchFavoriteData() {
    isomorphic_fetch__WEBPACK_IMPORTED_MODULE_4___default()("http://localhost:9000/favorite").then(res => res.json()).then(data => {
      console.log(data);
      this.setState({
        favItemList: data
      });
  ...
  removeFavItem(favItem) {
    this.showInitButton = false;
    this.setState({
      favItemList: this.state.favItemList.filter(item => item.index !== favItem.index)
    });
  }
  ...
  render() {
    ...
    return __jsx(_component_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      className: _public_utils_module_css__WEBPACK_IMPORTED_MODULE_5___default.a.cardPosition,
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 52,
    ...
    }, "Featured"), __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_6__["Card"].Body, {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 55,
      ...
      className: _public_utils_module_css__WEBPACK_IMPORTED_MODULE_5___default.a.topClearance,
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 65,
    ...
    }, favItemList.length > 0 ? favItemList.map((element, key) => {
      return __jsx(_component_FavoriteItem__WEBPACK_IMPORTED_MODULE_3__["default"], {
        key: key,
        detail: element,
    ...
    }) : !this.showInitButton && !favItemList.length ? __jsx(_component_FavoriteItem__WEBPACK_IMPORTED_MODULE_3__["default"], {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 77,
...
module.exports = __webpack_require__(/*! D:\Demo App\demo-app\pages\favorite.js */"./pages/favorite.js");

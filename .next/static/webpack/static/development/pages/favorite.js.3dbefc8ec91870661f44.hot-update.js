...
var deleteFavItem = function deleteFavItem(_ref) {
  var detail, onRemoveItem, requestOptions, response;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function deleteFavItem$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          detail = _ref.detail, onRemoveItem = _ref.onRemoveItem;
          requestOptions = {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
            },
            body: JSON.stringify(props.detail)
          };
          _context.next = 4;
...
var FavoriteItem = function FavoriteItem(_ref2) {
...
//# sourceMappingURL=favorite.js.3dbefc8ec91870661f44.hot-update.js.map